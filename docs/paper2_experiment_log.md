...
| 25 | Cross-molecule transfer: aspirin-trained on ethanol | 🟢 | Tests whether routing transfers across distribution | `routing_on_ethanol.json` (running) |
| 26 | Cross-molecule transfer: ethanol-trained on aspirin | 💡 | Reverse direction — likely informative if (25) is positive | — |
