...
\caption{Three-way comparison on $S_3$ ternary task (num\_range=15). \textbf{Left:} complement split (1 ordering trains, 5 test). \textbf{Right:} composition split (transpositions train, 3-cycles test). Red annotations show the decomposition: +3.9pp from group structure, +2.1pp from routing architecture.}
\label{fig:threeway}
\end{figure}
...
\bibitem{penguin2025}
PEnGUiN: Partially equivariant graph neural networks.
\newblock In \emph{Reinforcement Learning Journal}, 2025.
